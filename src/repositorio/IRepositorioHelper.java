...
/**
 * repositorio/IRepositorioHelper.java . Generated by the IDL-to-Java compiler
 * (portable), version "3.2" from
 * C:/Dev/workspace352/OrgRepos/idl/IRepositorio.idl Tuesday, August 29, 2017
 * 12:22:07 AM CEST
 */
...
abstract public class IRepositorioHelper {
	...
	synchronized public static org.omg.CORBA.TypeCode type() {
		if (__typeCode == null) {
			__typeCode = org.omg.CORBA.ORB.init().create_interface_tc(
					repositorio.IRepositorioHelper.id(), "IRepositorio");
		}
		return __typeCode;
	}
	...
	public static void write(org.omg.CORBA.portable.OutputStream ostream,
			repositorio.IRepositorio value) {
