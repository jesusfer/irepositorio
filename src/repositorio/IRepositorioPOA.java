 ...
 implements repositorio.IRepositorioOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  static
  {
    ...
    _methods.put ("solicitarBloque", new java.lang.Integer (7));
    _methods.put ("registrar", new java.lang.Integer (8));
    _methods.put ("registrarConNombre", new java.lang.Integer (9));
    _methods.put ("baja", new java.lang.Integer (10));
  }
  ...
  // TODO Recuperar documentos
       ...
       case 7:  // repositorio/IRepositorio/solicitarBloque
       {
         String nombre = in.read_string ();
         byte $result[] = null;
  ...
  // Registrar repositorios subordinados
       case 8:  // repositorio/IRepositorio/registrar
       {
       ...
       case 9:  // repositorio/IRepositorio/registrarConNombre
       {
         repositorio.IRepositorio referencia = repositorio.IRepositorioHelper.read (in);
         String nombre = in.read_string ();
         String $result = null;
  ...
  // Dar de baja un repositorio
       case 10:  // repositorio/IRepositorio/baja
       {
         String nombre = in.read_string ();
         this.baja (nombre);
         out = $rh.createReply();
