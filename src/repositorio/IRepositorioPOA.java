 ...
 implements repositorio.IRepositorioOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  static
  {
    ...
    _methods.put ("_set_subordinados", new java.lang.Integer (3));
    _methods.put ("_get_nombre", new java.lang.Integer (4));
    _methods.put ("_set_nombre", new java.lang.Integer (5));
    _methods.put ("buscar", new java.lang.Integer (6));
    _methods.put ("iniciarDescarga", new java.lang.Integer (7));
    _methods.put ("solicitarBloque", new java.lang.Integer (8));
    _methods.put ("registrar", new java.lang.Integer (9));
    _methods.put ("registrarConNombre", new java.lang.Integer (10));
    _methods.put ("baja", new java.lang.Integer (11));
  }
  ...
  ///////////////////////////////////
       ...
       case 2:  // repositorio/IRepositorio/_get_subordinados
       {
         ...
         out = $rh.createReply();
         repositorio.StringSeqHelper.write (out, $result);
         break;
       }

       case 3:  // repositorio/IRepositorio/_set_subordinados
       {
         String newSubordinados[] = repositorio.StringSeqHelper.read (in);
         this.subordinados (newSubordinados);
         out = $rh.createReply();
         break;
       }

       case 4:  // repositorio/IRepositorio/_get_nombre
       {
         String $result = null;
         $result = this.nombre ();
         out = $rh.createReply();
       ...
       case 5:  // repositorio/IRepositorio/_set_nombre
       {
  ...
  // TODO Búsqueda por palabras clave
       case 6:  // repositorio/IRepositorio/buscar
       {
  ...
  // TODO Recuperar documentos
       case 7:  // repositorio/IRepositorio/iniciarDescarga
       {
         String nombre = in.read_string ();
         this.iniciarDescarga (nombre);
         out = $rh.createReply();
         break;
       }

       case 8:  // repositorio/IRepositorio/solicitarBloque
       {
         String nombre = in.read_string ();
         byte $result[] = null;
         $result = this.solicitarBloque (nombre);
         out = $rh.createReply();
  ...
  // Registrar repositorios subordinados
       case 9:  // repositorio/IRepositorio/registrar
       {
       ...
       case 10:  // repositorio/IRepositorio/registrarConNombre
       {
         repositorio.IRepositorio referencia = repositorio.IRepositorioHelper.read (in);
         String nombre = in.read_string ();
         String $result = null;
  ...
  // Dar de baja un repositorio
       case 11:  // repositorio/IRepositorio/baja
       {
         String nombre = in.read_string ();
         this.baja (nombre);
         out = $rh.createReply();
