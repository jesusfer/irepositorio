...
public class _IRepositorioStub extends org.omg.CORBA.portable.ObjectImpl implements repositorio.IRepositorio
{
  ...
  public String registrar (repositorio.IRepositorio referencia) throws repositorio.RegistroNoPosibleException
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                ...
                $in = $ex.getInputStream ();
                String _id = $ex.getId ();
                if (_id.equals ("IDL:repositorio/RegistroNoPosibleException:1.0"))
                    throw repositorio.RegistroNoPosibleExceptionHelper.read ($in);
                else
                    throw new org.omg.CORBA.MARSHAL (_id);
            } catch (org.omg.CORBA.portable.RemarshalException $rm) {
  ...
  public String registrarConNombre (repositorio.IRepositorio referencia, String nombre) throws repositorio.RegistroNoPosibleException
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
