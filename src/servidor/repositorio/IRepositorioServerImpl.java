...
/**
 * Implementación de la parte servidor del Repositorio.
 */
public class IRepositorioServerImpl extends repositorio.IRepositorioPOA {
	...
	public Coincidencia[] buscar(String palabraClave) {
		...
		// Si añado el local aquí, provocamos recursividad infinita
		for (IRepositorio sub : subordinados()) {
			repos.add(sub);
		}

		// Un hilo por cada repositorio, incluído el local con su propia clase
	...
	public ITransferencia iniciarDescarga(String nombre) throws ArchivoNoEncontradoException {
		...
		// Se busca el archivo en el índice y se pasan los detalles al hilo que atiende
	 ...
	 * 
	 * TODO Se podría también mantener la lista de hijos localmente también usando
	 * este método.
	 * 
